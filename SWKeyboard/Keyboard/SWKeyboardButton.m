...
@implementation SWKeyboardButton

+ (instancetype)keyboardButtonWithStyle:(SWKeyboardButtonStyle)style {
    SWKeyboardButton *button = [self buttonWithType:UIButtonTypeCustom];
    button.style = style;
    return button;
}
...
- (void)setStyle:(SWKeyboardButtonStyle)style {
    if (style != _style) {
        _style = style;
        [self _buttonStyleDidChange];
    }
...
- (void)_buttonStyleDidChange {
    ...
    } else if (style == SWKeyboardButtonStyleDone) {
    ...
    if (style == SWKeyboardButtonStyleDone) {
